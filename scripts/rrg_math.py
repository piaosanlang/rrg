...
SECTOR_HOLDINGS: Dict[str, List[Dict[str, str]]] = {
    ...
    "XLE": [
        ...
        {"ticker": "HES",   "name": "Hess",            "color": "#ef4444"},
        ...
        {"ticker": "MRO",   "name": "Marathon Oil",    "color": "#facc15"},
    ],
    ...
    "XLC": [
        ...
        {"ticker": "TMUS",  "name": "T-Mobile",        "color": "#ec4899"},
        {"ticker": "VZ",    "name": "Verizon",         "color": "#06b6d4"},
        {"ticker": "T",     "name": "AT&T",            "color": "#84cc16"},
        {"ticker": "CHTR",  "name": "Charter",         "color": "#f43f5e"},
        {"ticker": "EA",    "name": "EA",              "color": "#a78bfa"},
        {"ticker": "TTWO",  "name": "Take-Two",        "color": "#22c55e"},
        {"ticker": "FOX",   "name": "Fox",             "color": "#eab308"},
        {"ticker": "FOXA",  "name": "Fox A",           "color": "#14b8a6"},
        {"ticker": "WBD",   "name": "Warner Bros.",    "color": "#ef4444"},
        {"ticker": "OMC",   "name": "Omnicom",         "color": "#6366f1"},
        {"ticker": "IPG",   "name": "Interpublic",     "color": "#d946ef"},
        {"ticker": "MTCH",  "name": "Match",           "color": "#0ea5e9"},
        {"ticker": "LYV",   "name": "Live Nation",     "color": "#65a30d"},
        {"ticker": "NWS",   "name": "News Corp",       "color": "#c026d3"},
        {"ticker": "NWSA",  "name": "News Corp A",     "color": "#facc15"},
    ],
}
